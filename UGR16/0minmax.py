...
min_max_0(df, 'source_port')
min_max_0(df, 'dest_port')
min_max_0(df, 'forward_status')
min_max_0(df, 'type_service')
min_max_0(df, 'pack_exch')
min_max_0(df, 'bytes')
